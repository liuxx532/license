...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "license@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "license API";

        private String description = "license API documentation";
